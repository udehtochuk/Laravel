...
<body>
  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="brand">
          <a href="#hero">
            <h1><span>L</span>ara <span>v</span>el</h1>
          </a>
        </div>
        <div class="nav-list">
          <div class="hamburger">
  ...
  <!-- Hero Section  -->
  <section style="background-image: url({{ asset('img/hero-bg.png') }});"; id="hero">
    <div class="hero container">
      <div>
        <h1>Hello, <span></span></h1>
        <h1>My Name is <span></span></h1>
        <h1>Elite <b style="color:#fff;">DevOps</b> <span></span></h1>
      ...
      <div class="all-projects">
        <div class="project-item">
          ...
          <div class="project-img">
            <img src="{{ asset('img/img-1.png') }}" alt="img">
          </div>
        </div>
        <div class="project-item">
          <div class="project-info">
  ...
  <section id="about">
    <div class="about container">
      <div class="col-left">
        <div class="about-img">
          <img src="{{ asset('img/img-2.png') }}" alt="img">
        </div>
      </div>
      <div class="col-right">
